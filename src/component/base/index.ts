...
async function addPhysicsTest(demo: ThreeDemo, world: World) {
    ...
    const planeModel = await loadGltfModelFunc('/src/assets/model/gltf/plane.gltf', new THREE.Vector3(-5, 10, -5), new THREE.Vector3(0.25, 0.25, 0.25))
    const {
    ...
    //添加房子
    const houseModel = await loadGltfModelFunc('/src/assets/model/gltf/littlest-tokyo.glb', new THREE.Vector3(0, 2.2, 0), new THREE.Vector3(0.01, 0.01, 0.01))
    const {
